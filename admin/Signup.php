...
<div class="container">
	 <h1 class="text-gray text-center font-bold">Signup</h1>
	 <br>
    <div class="leading-loose">
     <?php
		...
		$limit=10;
			...
			$a="SELECT * from signup limit {$offset},{$limit}";
...
<?php
			...
			<?php
				...
				{
					echo"<li class='page-item'><a class='page-link' href='signup.php?page=$i'>$i</a></li>";
				}
				?>
