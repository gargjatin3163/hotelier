                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="contact-info">
                            ...
                            <div class="contact-text">
                                <h3>Address</h3>
                                <p>56, Janpath Rd, ALPS Building, Rear Block, Upper Ground Floor, Atul Grove Road, Janpath, Connaught Place, New Delhi, Delhi 110001</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                ...
                <div class="row contact-form">
                    <div class="col-md-12">
                        ...
                        <form method="post" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="subject" name="subj" placeholder="Subject" required="required" data-validation-required-message="Please enter a subject" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                            ...
                            <div>
                                <button class="btn custom-btn" type="submit" name="sub1" id="sendMessageButton">Send Message</button>
                            </div>
                        </form>
						<?php
						include"proconn.php";
