                    ...
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-3">
                                ...
                                <p><i class="fa fa-map-marker-alt "></i>&nbsp;57RJ+R7 - Dubai Fountain St - Downtown Dubai - Dubai - United Arab Emirates</p>
                            </div>
                            <div class="col-md-3">
                                <h6 class="section-title text-start text-primary text-uppercase">Call Us</h6>
                            ...
                            <div class="col-md-3">
                                ...
                                <p><i class="fa fa-envelope"></i>&nbsp;manager@hotelier.com</p>
                            </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" name="sub1" type="submit">Send Message</button>
                                    </div>
									<?php
						include"mconn.php";
						if (isset ($_POST['sub1']))
